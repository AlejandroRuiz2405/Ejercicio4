...
titulo = Label(frame,text="CALCULADORA DE OPERACIONES BASICAS")
...
lbl_numeroa = Label(raiz, text="Numero 1").place(relx=0.2,rely=0.2)
...
lbl_numerob = Label(raiz, text="Numero 2").place(relx=0.2,rely=0.3)
